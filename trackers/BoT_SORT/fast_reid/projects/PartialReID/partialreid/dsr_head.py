...
from BoT_SORT.fast_reid.fastreid.modeling.heads import EmbeddingHead
from BoT_SORT.fast_reid.fastreid.modeling.heads.build import REID_HEADS_REGISTRY
from BoT_SORT.fast_reid.fastreid.layers.weight_init import weights_init_kaiming
