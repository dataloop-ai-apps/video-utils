...
from BoT_SORT.fast_reid.fastreid.data.build import _root, build_reid_test_loader, build_reid_train_loader
from BoT_SORT.fast_reid.fastreid.data.datasets import DATASET_REGISTRY
from BoT_SORT.fast_reid.fastreid.data.transforms import build_transforms
from BoT_SORT.fast_reid.fastreid.engine import hooks
from BoT_SORT.fast_reid.fastreid.engine.defaults import DefaultTrainer, TrainerBase
from BoT_SORT.fast_reid.fastreid.engine.train_loop import SimpleTrainer, AMPTrainer
from BoT_SORT.fast_reid.fastreid.solver import build_optimizer
...
from BoT_SORT.fast_reid.fastreid.utils.params import ContiguousParams
