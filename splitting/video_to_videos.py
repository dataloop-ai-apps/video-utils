...
class ServiceRunner(dl.BaseServiceRunner):
    ...
    def process_video_split(self, cap, annotations, start_frame, end_frame, i):
        """
        Process a single video split by writing frames and collecting annotations
        :param cap: VideoCapture object for the input video
        :param annotations: Annotations object for the input video
        :param start_frame: Starting frame index for this split
        :param end_frame: Ending frame index for this split
        :param i: Split index number
        :return: Tuple of (sub_video_name, sub_video_annotations)
        """
